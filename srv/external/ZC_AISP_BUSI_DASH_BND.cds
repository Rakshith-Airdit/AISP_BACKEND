/* checksum : 4fe8cc8444a119d54c1f564435dc7edf */
@cds.external : true
...
entity ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_MY_BUSINESSSet {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  key p_vendorcode : String(10) not null;
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  ...
  Parameters : Association to ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_MY_BUSINESS {  };
};
...
entity ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_MY_BUSINESS {
  @sap.display.format : 'UpperCase'
  ...
  @sap.filterable : 'false'
  key p_vendorcode : String(10) not null;
  Set : Association to many ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_MY_BUSINESSSet {  };
};
...
entity ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_MY_COMMITMENTSSet {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  key p_vendorcode : String(10) not null;
  @sap.display.format : 'UpperCase'
  ...
  @sap.filterable : 'false'
  Parameters : Association to ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_MY_COMMITMENTS {  };
};
...
@sap.content.version : '1'
@sap.semantics : 'parameters'
entity ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_MY_COMMITMENTS {
  @sap.display.format : 'UpperCase'
  @sap.parameter : 'mandatory'
  @sap.label : 'Supplier'
  @sap.creatable : 'false'
  ...
  @sap.filterable : 'false'
  key p_vendorcode : String(10) not null;
  Set : Association to many ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_MY_COMMITMENTSSet {  };
};
...
entity ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_TOP5_OPEN_POSet {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  key p_vendorcode : String(10) not null;
  @sap.display.format : 'UpperCase'
  ...
  TotalOrderedQuantityUnit : String(3);
  @sap.filterable : 'false'
  Parameters : Association to ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_TOP5_OPEN_PO {  };
};
...
@sap.content.version : '1'
@sap.semantics : 'parameters'
entity ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_TOP5_OPEN_PO {
  @sap.display.format : 'UpperCase'
  @sap.parameter : 'mandatory'
  @sap.label : 'Supplier'
  @sap.creatable : 'false'
  ...
  @sap.filterable : 'false'
  key p_vendorcode : String(10) not null;
  Set : Association to many ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_TOP5_OPEN_POSet {  };
};
...
entity ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_TOP5_PRODUCTSSet {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Supplier'
  key p_vendorcode : String(10) not null;
  @sap.display.format : 'UpperCase'
  ...
  TotalAmountCurrency : String(5);
  @sap.filterable : 'false'
  Parameters : Association to ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_TOP5_PRODUCTS {  };
};
...
@sap.content.version : '1'
@sap.semantics : 'parameters'
entity ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_TOP5_PRODUCTS {
  @sap.display.format : 'UpperCase'
  @sap.parameter : 'mandatory'
  @sap.label : 'Supplier'
  @sap.creatable : 'false'
  ...
  @sap.filterable : 'false'
  key p_vendorcode : String(10) not null;
  Set : Association to many ZC_AISP_BUSI_DASH_BND.ZC_AISP_BD_TOP5_PRODUCTSSet {  };
};

@cds.external : true
@cds.persistence.skip : true
@sap.content.version : '1'
entity ZC_AISP_BUSI_DASH_BND.SAP__Currencies {
  @sap.label : 'Currency'
  @sap.semantics : 'currency-code'
...
@cds.persistence.skip : true
@sap.content.version : '1'
entity ZC_AISP_BUSI_DASH_BND.SAP__UnitsOfMeasure {
